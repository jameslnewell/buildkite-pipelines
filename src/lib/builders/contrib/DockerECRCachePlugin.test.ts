...
describe(DockerECRCachePlugin.name, () => {
  ...
  describe('.cacheOn()', () => {
    ...
    test('is an array when specified', () => {
      ...
      expect(plugin.build()[DockerECRCachePlugin.PLUGIN]).toHaveProperty('cache-on', [
        glob,
      ]);
    });
  });
  ...
  describe('.secret()', () => {
    ...
    test('is an array when specified', () => {
      ...
      expect(plugin.build()[DockerECRCachePlugin.PLUGIN]).toHaveProperty('secrets', [
        secret,
      ]);
    });
  });
  ...
  describe('.buildArg()', () => {
    ...
    test('is an array when specified', () => {
      ...
      expect(plugin.build()[DockerECRCachePlugin.PLUGIN]).toHaveProperty('build-args', [
        buildArg,
      ]);
    });
  });
